#ifndef MASTER_KPABE_LARGE_H
#define MASTER_KPABE_LARGE_H
...
namespace kpabe_large {
    ...
    struct secret_key {
        TTree *policy{};
        std::map<TAttribute, g2_t *> Ds;
        std::map<TAttribute, g1_t *> Rs;
    };
    ...
    void serialize_sk(std::vector<unsigned char>& data, const secret_key& sk) {
        ...
        serialize_tattribute_g2_t_map<ATTR_TYPE, ATTR_TYPE, IDENTITY_SIZE_TYPE>(data, sk.Ds);
        serialize_tattribute_g1_t_map<ATTR_TYPE, ATTR_TYPE, IDENTITY_SIZE_TYPE>(data, sk.Rs);
    }
    ...
    secret_key deserialize_sk(const std::vector<unsigned char>& data, int *offset_ptr) {
        ...
        sk.Ds = deserialize_tattribute_g2_t_map<ATTR_TYPE, ATTR_TYPE, IDENTITY_SIZE_TYPE>(data, offset_ptr);
        sk.Rs = deserialize_tattribute_g1_t_map<ATTR_TYPE, ATTR_TYPE, IDENTITY_SIZE_TYPE>(data, offset_ptr);
        return sk;
    }
