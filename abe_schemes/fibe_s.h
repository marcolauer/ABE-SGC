#ifndef MASTER_FIBE_S_H
#define MASTER_FIBE_S_H
...
namespace fibe_s {
    ...
    /**
     * Runs the setup algorithm of the small universe Fuzzy-IBE scheme.
    ...
    /**
     * Runs the key generation algorithm of the small universe Fuzzy-IBE scheme.
     ...
     */
    void key_generation(secret_key& sk, bn_t order, int d, const std::vector<int>& identity, const master_key& mk);

    /**
     * Runs the encryption algorithm of the small universe Fuzzy-IBE scheme.
    ...
    /**
     * Runs the decryption algorithm of the small universe Fuzzy-IBE scheme.
    ...
    /**
     * Frees the allocated content in the ABE master key data structure of the small universe Fuzzy-IBE scheme.
     * @param[out] mk the (empty) ABE master key.
     */
    void free_master_key(master_key& mk);

    /**
     * Frees the allocated content in the ABE public key data structure of the small universe Fuzzy-IBE scheme.
     * @param[out] pk the (empty) ABE public key.
     */
    void free_public_key(public_key& pk);

    /**
     * Frees the allocated content in the ABE secret key data structure of the small universe Fuzzy-IBE scheme.
     * @param[out] sk the (empty) ABE secret key.
     */
    void free_secret_key(secret_key& sk);

    /**
     * Frees the allocated content in the ABE ciphertext data structure of the small universe Fuzzy-IBE scheme.
    ...
    /**
     * Serializes the ABE master key data structure of the small universe Fuzzy-IBE scheme to bytes.
    ...
    /**
     * Deserializes the ABE master key data structure of the small universe Fuzzy-IBE scheme from bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
    ...
    /**
     * Serializes the ABE public key data structure of the small universe Fuzzy-IBE scheme to bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
    ...
    /**
     * Deserializes the ABE public key data structure of the small universe Fuzzy-IBE scheme from bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
    ...
    /**
     * Serializes the ABE secret key data structure of the small universe Fuzzy-IBE scheme to bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
    ...
    /**
     * Deserializes the ABE secret key data structure of the small universe Fuzzy-IBE scheme from bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
     * @tparam IDENTITY_SIZE_TYPE the data type used for serializing the length of the identities / access structures
     *      (e.g. uint8_t, uint16_t, ...).
    ...
    /**
     * Serializes the ABE ciphertext data structure of the small universe Fuzzy-IBE scheme to bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
     * @tparam IDENTITY_SIZE_TYPE the data type used for serializing the length of the identities / access structures
     *      (e.g. uint8_t, uint16_t, ...).
    ...
    /**
     * Deserializes the ABE ciphertext data structure of the small universe Fuzzy-IBE scheme from bytes.
     * @tparam ATTR_TYPE the data type used for the attributes (e.g. uint8_t, uint16_t, ...).
     * @tparam IDENTITY_SIZE_TYPE the data type used for serializing the length of the identities / access structures
     *      (e.g. uint8_t, uint16_t, ...).
