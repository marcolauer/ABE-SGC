#ifndef MASTER_CPABBE_H
#define MASTER_CPABBE_H
...
namespace cpabbe {
    ...
    void serialize_sk(std::vector<unsigned char>& data, const secret_key& sk) {
        ...
        serialize_g1_t_vector<ATTR_TYPE>(data, sk.D4s);
        serialize_g1_t_vector<ATTR_TYPE>(data, sk.D5s);
    }
    ...
    secret_key deserialize_sk(const std::vector<unsigned char>& data, int *offset_ptr) {
        ...
        sk.D4s = deserialize_g1_t_vector<ATTR_TYPE>(data, offset_ptr);
        sk.D5s = deserialize_g1_t_vector<ATTR_TYPE>(data, offset_ptr);
        return sk;
    }
    ...
    void serialize_ct(std::vector<unsigned char>& data, const ciphertext& ct) {
        ...
        serialize_g2_t(data, *ct.C3);
        serialize_g2_t(data, *ct.C4);
    }
    ...
    ciphertext deserialize_ct(const std::vector<unsigned char>& data, int *offset_ptr) {
        ...
        deserialize_g2_t(*ct.C3, data, offset_ptr);
        ct.C4 = static_cast<g2_t *>(malloc(sizeof(g2_t)));
        g2_util_null_init(*ct.C4);
        deserialize_g2_t(*ct.C4, data, offset_ptr);
        return ct;
    }
}

#endif //MASTER_CPABBE_H
