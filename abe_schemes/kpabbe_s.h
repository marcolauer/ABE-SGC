#ifndef MASTER_KPABBE_S_H
#define MASTER_KPABBE_S_H
...
namespace kpabbe_s {
    ...
    void serialize_pk(std::vector<unsigned char>& data, const public_key& pk) {
        ...
        serialize_g1_t_vector<ATTR_TYPE>(data, pk.v0s);
        serialize_g1_t_vector<ATTR_TYPE>(data, pk.v1s);
    }
    ...
    public_key deserialize_pk(const std::vector<unsigned char>& data, int *offset_ptr) {
        ...
        pk.v0s = deserialize_g1_t_vector<ATTR_TYPE>(data, offset_ptr);
        pk.v1s = deserialize_g1_t_vector<ATTR_TYPE>(data, offset_ptr);
        return pk;
    }
    ...
    void serialize_sk(std::vector<unsigned char>& data, const secret_key& sk) {
        ...
        serialize_g2_t(data, *sk.D4);
        serialize_g2_t(data, *sk.D5);
    }
    ...
    secret_key deserialize_sk(const std::vector<unsigned char>& data, int *offset_ptr) {
        ...
        deserialize_g2_t(*sk.D4, data, offset_ptr);
        sk.D5 = static_cast<g2_t *>(malloc(sizeof(g2_t)));
        g2_util_null_init(*sk.D5);
        deserialize_g2_t(*sk.D5, data, offset_ptr);
        return sk;
    }
    ...
    void serialize_ct(std::vector<unsigned char>& data, const ciphertext& ct) {
        ...
        serialize_g1_t_vector<ATTR_TYPE>(data, ct.C3s);
        serialize_g1_t_vector<ATTR_TYPE>(data, ct.C4s);
    }
    ...
    ciphertext deserialize_ct(const std::vector<unsigned char>& data, int *offset_ptr) {
        ...
        ct.C3s = deserialize_g1_t_vector<ATTR_TYPE>(data, offset_ptr);
        ct.C4s = deserialize_g1_t_vector<ATTR_TYPE>(data, offset_ptr);
        return ct;
    }
}

#endif //MASTER_KPABBE_S_H
